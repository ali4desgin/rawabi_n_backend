                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach($orders as $order)
                                ...
                                <tr>
                                    ...
                                    <td><a  href="{{ route("admin_change_status_user",["user_id"=>$order["id"],"status"=>"active"]) }}" class="btn btn-info btn-sm"> عرض</a></td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        @elseif($order["status"]=="pending")
                                            <a  href="{{ route("admin_change_status_order",["order_id"=>$order["id"],"status"=>"active"]) }}" class="confirm btn btn-success btn-sm">تفعيل الطلب</a>

                                        @else

                                            <a  href="{{ route("admin_change_status_order",["order_id"=>$order["id"],"status"=>"closed"]) }}" class="confirm btn btn-danger btn-sm">اغلاق الطلب</a>
